...
export default async function TrackingAdminListPage(){if(!(await isAdminAuthenticated()))redirect("/admin/tracking/login");return <TrackingList initialRecords={await getAllTrackings()}/>;}
