...
<div className="hidden lg:flex flex-row self-start bg-transparent dark:bg-transparent items-center justify-between py-2 max-w-7xl mx-auto px-4 rounded-full relative z-[60] w-full" style={{minWidth: "940px", transform: "none", backdropFilter: "blur(0px)", boxShadow: "rgba(34, 42, 53, 0) 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px, rgba(34, 42, 53, 0) 0px 0px 0px 0px, rgba(34, 42, 53, 0) 0px 0px 0px, rgba(47, 48, 55, 0) 0px 0px 0px, rgba(255, 255, 255, 0) 0px 0px 0px inset", width: "100%"}}>
  <a aria-label="ConTurk Shipping home" className="shrink-0 cursor-pointer z-50" href="/"><span className="inline-flex shrink-0 items-center"><img alt="ConTurk Shipping" width="147" height="30" decoding="async" data-nimg="1" className="w-auto select-none block dark:hidden" style={{color: "transparent", height: "30px", width: "auto"}} src="/images/conturk-logo-dark-text.png" /><img alt="" aria-hidden="true" width="147" height="30" decoding="async" data-nimg="1" className="w-auto select-none hidden dark:block" style={{color: "transparent", height: "30px", width: "auto"}} src="/images/conturk-logo-light-text.png" /></span></a>
  <div className="lg:flex flex-row flex-1 hidden items-center justify-center space-x-1 xl:space-x-2 text-sm text-zinc-600 font-medium hover:text-zinc-800 transition duration-200"><a className="relative shrink-0 whitespace-nowrap px-2.5 py-2 transition-colors xl:px-3 text-neutral-600 dark:text-neutral-300" href="/about-us"><span className="relative z-20">About Us</span></a><a className="relative shrink-0 whitespace-nowrap px-2.5 py-2 transition-colors xl:px-3 text-neutral-600 dark:text-neutral-300" href="/services"><span className="relative z-20">Services</span></a><a className="relative shrink-0 whitespace-nowrap px-2.5 py-2 transition-colors xl:px-3 text-neutral-600 dark:text-neutral-300" href="/insurance-and-terms"><span className="relative z-20">Insurance & Terms</span></a><a className="relative shrink-0 whitespace-nowrap px-2.5 py-2 transition-colors xl:px-3 text-neutral-600 dark:text-neutral-300" href="/announcements"><span className="relative z-20">Announcements</span></a><a className="relative shrink-0 whitespace-nowrap px-2.5 py-2 transition-colors xl:px-3 text-neutral-600 dark:text-neutral-300" href="/contact-us"><span className="relative z-20">Contact Us</span></a></div>
  <div className="flex shrink-0 items-center gap-3">
    ...
    {/* Optional: uncomment to restore the source Get a Quote CTA. */}
    {/* <a className="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive bg-primary text-primary-foreground shadow-xs hover:bg-primary/90 h-9 rounded-lg px-3 z-50 cursor-pointer" href="#contact-strip">Get a Quote</a> */}
  </div>
</div>
  );
}
